// port-lint: source src/values/typing/typeCompiled/tests.rs
...
""",
    ...
    @Test
    fun testNewSyntaxWithoutDotTypeCompileTime() {
...
""",
    ...
    @Test
    fun testNewSyntaxWithoutDotTypeRuntime() {
        Assert.pass(
            """
...
""",
    ...
    @Test
    fun testTypeCompiledStarlarkApi() {
    ...
    @Test
    fun testEvalTypeEvalType() {
        Assert.isTrue("isinstance(1, eval_type(eval_type(int)))")
    }

    @Test
    fun testTypeCompiledCanBeUsedInFunctionSignature() {
        Assert.pass(
            """
ty = eval_type(int)
def f(x: ty):
...
""",
    ...
    @Test
    fun testNewListDictSyntaxFailCompileTime() {
        Assert.fail(
            """
def uuu(x: list[int]):
    pass
...
""",
    ...
    @Test
    fun testNewListDictSyntaxFailRuntime() {
        Assert.fail(
            """
def uuu(x: list[int]):
    pass
