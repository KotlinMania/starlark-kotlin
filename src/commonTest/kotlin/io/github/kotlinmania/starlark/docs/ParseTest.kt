// port-lint: source tests:src/docs/parse.rspackage io.github.kotlinmania.starlark.docs
...
"""
        assertEquals(
            DocString(
                ...
                details = "This should be a multiline set of details.\n" +
                    "It should be:\n" +
                    "    - Dedented\n" +
                    "    - Trimmed\n" +
                    "    - Split properly from the summary",
        ...
        assertEquals(
            DocString(
                ...
                details = "Typing the first line right after the \"\"\" in python docstrings is common,\n" +
                    "while putting the rest of the docstring indented. Just support both so it\n" +
                    "doesn't surprise anyone.",
                examples = null,
            ),
    ...
    fun parsesRustDocstring() {
        ...
        assertEquals(
            DocString(
                ...
                details = null,
                examples = "This is the second part. It has some code blocks\n\n" +
                    "```\n" +
                    "\"bar\"\n" +
                    "```\n\n" +
                    "```python\n" +
    ...
    fun parsesAndRemovesSectionsFromStarlarkDocstring() {
        ...
        val expectedDocstring = DocString.fromDocstring(
            DocStringKind.Starlark,
    ...
    fun parsesStarlarkFunctionDocstring() {
        ...
        // fromDocstring normalizes the summary by collapsing newlines into spaces
        assertEquals(
            DocString.fromDocstring(
                kind,
