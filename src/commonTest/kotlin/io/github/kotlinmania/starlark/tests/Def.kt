// port-lint: source src/tests/def.rs
...
class DefTests {
    ...
    @Test
    fun testLambdaCaptureFromModule() {
        Assert.isTrue(
            """
    f = lambda y: x + y
    x = 100
    ...
    @Test
    fun testLambdaCaptureReassignedFromDef() {
        Assert.isTrue(
            """
    def inside():
        x = 100
    ...
    @Test
    fun testDoubleCaptureAndFreeze() {
        val a = Assert()
        a.module(
            "x.bzl",
            """
