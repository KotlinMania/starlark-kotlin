...
/// the same heap.
///
/// **Note:** In Kotlin Multiplatform, there are no lifetime parameters. The branding concept from
/// Rust does not directly apply. Values are managed by the JVM/native garbage collector, and heap
/// ownership is tracked at the API level rather than enforced by the type system.
///
/// To see how this works in practice (in Rust), consider an example of how this might fail.
...
/// confusion" that we want to disallow, and indeed this fails to compile in Rust.
///
/// ### Implementation
///
