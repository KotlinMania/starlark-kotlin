...
import io.github.kotlinmania.starlark_kotlin.typing.starlark_value.TyStarlarkValue
...
import io.github.kotlinmania.starlark_kotlin.values.dict.value.ValueStr
import io.github.kotlinmania.starlark_kotlin.values.enumeration.EnumValue
import io.github.kotlinmania.starlark_kotlin.values.enumeration.matcher.EnumTypeMatcher
import io.github.kotlinmania.starlark_kotlin.values.enumeration.ty_enum_type.TyEnumData
...
private fun enumTypeMethods(builder: MethodsBuilder) {
    ...
    builder.attribute("type") { thisValue, heap ->
        ...
        when {
            tyEnumType != null -> heap.alloc(tyEnumType.name)
            else -> heap.alloc(EnumValue.TYPE)
        }
    }
