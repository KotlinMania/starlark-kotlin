...
class ValueOf<T>(
    ...
    override fun starlarkTypeRepr(): Ty {
        return StarlarkTypeRepr.typeReprOf(typed!!)
    }
    ...
    companion object {
        ...
        inline fun <reified T : Any> unpackValueImpl(value: Value): ValueOf<T>? {
            val typed = UnpackValue.unpack<T>(value) ?: return null
