...
private fun minMaxIter(
    it: Iterator<io.github.kotlinmania.starlark.values.layout.Value>,
    key: io.github.kotlinmania.starlark.values.layout.Value?,
    eval: Evaluator,
 ...
 */
internal fun registerMinMax(globals: io.github.kotlinmania.starlark.environment.GlobalsBuilder) {
    /**
