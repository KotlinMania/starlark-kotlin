// port-lint: source values/types/list/value.rs
...
class ListData(
    ...
    private fun reserveAdditionalSlow(additional: Int) {
        ...
        // Round up to at least 4 to avoid pathologically small initial allocations.
...
// Frozen and unfrozen lists share `ListGen`; the inner data type distinguishes them.
