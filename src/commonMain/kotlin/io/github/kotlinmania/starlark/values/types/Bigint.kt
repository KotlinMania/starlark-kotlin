...
class StarlarkBigInt private constructor(
    ...
    companion object {
        ...
        internal fun uncheckedNew(value: BigInteger): StarlarkBigInt = StarlarkBigInt(value)
        ...
        internal fun cmpBigSmall(a: StarlarkBigInt, b: InlineInt): Int = -cmpSmallBig(b, a)
    }

    override fun compareTo(other: StarlarkBigInt): Int = value.compareTo(other.value)
    ...
    internal fun toF64(): Double = value.doubleValue(exactRequired = false)
     ...
     */
    fun equalsI32(
        @Suppress("UNUSED_PARAMETER") other: Int,
    ): Boolean = false
    ...
    fun allocFrozenValue(heap: FrozenHeap): FrozenValue = heap.allocSimple(this)
    ...
    override fun minus(heap: Heap): Result<Value> = Result.success(StarlarkInt.from(-value).allocValue(heap))

    /** Unary plus. Rust: `fn plus` */
    override fun plus(heap: Heap): Result<Value> = Result.success(StarlarkInt.from(value).allocValue(heap))
    ...
    override fun bitAnd(other: Value, heap: Heap): Result<Value> {
        val rhs =
            StarlarkIntRef.unpackValueOpt(other)
                ?: return ValueError.unsupportedWith(INT_TYPE, "&", other)
    ...
    override fun bitNot(heap: Heap): Result<Value> = Result.success(StarlarkIntRef.Big(this).not().allocValue(heap))
