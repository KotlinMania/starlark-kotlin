...
data class ResolvedArgName(
    ...
    /** ParameterP<AstNoPayload> index or `null` if the argument should go to kwargs. */
    val paramIndex: Int?,
) : ArgSymbol {
...
class Arguments(
    ...
    // Rust exposes this as a const-generic `positional::<N>(heap)`; tests use an `n` parameter.
